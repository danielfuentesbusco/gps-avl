...
<html lang="en">
  ...
  <!-- Fixed navbar -->
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="./seguimiento.php"><span class="fa fa-map-marker"></span> Rastreo</a></li>
                  ...
                  <div class="panel-heading clearfix">
                    ...
                    <tr> 
					 ...
					 <td style="padding-top: 14px;" nowrap>
						...
						<?php } ?>
						<?php echo $ubicacion;?>
					 <?php /*if($ubicacion=="Base"){ ?>
						 <i class="fa fa-home" aria-hidden="true" style="cursor:pointer;" data-toggle="tooltip" title="En Base"></i>
					 <?php }elseif($ubicacion=="KDM"){ ?>
						 <i class="fa fa-industry" aria-hidden="true" style="cursor:pointer;" data-toggle="tooltip" title="En KDM"></i>
					 <?php } else { ?>
						 <i class="fa fa-map-pin" aria-hidden="true" style="cursor:pointer;" data-toggle="tooltip" title="En <?php echo @$ubicacion;?>"></i>
					 <?php } */?>
					 
					 <?php if($external!=true) { 
						$car_alarm++;
					 ?>
					 <i class="fa fa-exclamation-triangle faa-flash animated" aria-hidden="true" style="cursor:pointer;color: #FFDF00;float: right;" data-toggle="tooltip" title="El GPS ha sido desconectado de la fuente de energía!"></i>
					 <?php } ?>
    ...
    <footer class="footer">
      <div class="container">
        <p class="text-muted" style="color: #008175;">Sistema de Rastreo 1.0 / Servitrans / 2016 &copy; Todos los derechos reservados / <span id="fecha"><?php echo date("d/m/Y H:i");?></span></p>
      </div>
    </footer>
    ...
    <script>	
      ...
      function init_map() {
		...
		var get_data = function(first){
			...
			$("#fecha").text(d.getDate()+"/"+m+"/"+d.getFullYear()+" "+d.getHours()+":"+d.getMinutes());
		}
