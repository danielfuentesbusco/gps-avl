  ...
  <body>  
    <div class="container">  
    	<div class="page-header" style="margin-top:0;">    
			<h3 style="margin-top:0;">Polígonos <small>Asignación</small></h3>
    	</div>
        <div class="row">
            <div class="col-md-12">
            	<div class="panel panel-default">
				  ...
				  <div class="col-md-2">
					...
					<select name="vid[]" class="form-control" multiple>
						<?php
				   ...
				   <div class="col-md-2">
					<div class="form-group">
					<label class="" for="pid">Polígono</label>
		...
		<?php 
			if(isset($_POST["btn-submit"])){
				...
				foreach($vid as $value){
					$q = "INSERT INTO geofence_device (geofence_id,device_id,fecha_inicio,fecha_termino) VALUES ($pid,$value,'$fecha',NULL);";
