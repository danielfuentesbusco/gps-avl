  ...
  <body>  
    <div class="container">  
    	<div class="page-header" style="margin-top:0;">    
			<h3>Conductor <small>ingreso de nuevo registro</small></h3>
    	</div>
        <div class="row">
            <div class="col-md-12">
            	<div class="panel panel-default">
				  ...
				  <div class="col-xs-3">
						...
						<input type="text" name="nombres" class="form-control" value="<?php echo @$_POST["nombres"];?>" required />
				  </div>
				  
				  <div class="col-xs-3">
						<label class="" for="vid">Paterno</label>
						<input type="text" class="form-control" name="paterno" value="<?php echo $_POST["paterno"];?>" required />
				  </div>
				  <div class="col-xs-3">
						<label class="" for="vid">Materno</label>
						<input type="text" name="materno" class="form-control" value="<?php echo @$_POST["materno"];?>" required />
				  </div> 
				  <div class="col-xs-2">
	...
	<script>
		<?php 
			if(isset($_POST["btn-submit"])){
				...
				$q = "INSERT INTO conductores (nombres,paterno,materno,rut,dv) VALUES ('{$_POST["nombres"]}','{$_POST["paterno"]}','{$_POST["materno"]}','{$_POST["rut"]}','{$_POST["dv"]}');";
				@mysql_query($q, $link);
		?>
