...
<html lang="en">
  <head>
    ...
    <title>Poligonos / Servitrans</title>
                  ...
                  <div class="panel-body">
				   <table class="table table-hover" style="font-size: 100%;">
                            ...
                            <tr>	
								...
								<th style="width: 70px;">
									...
									<ul class="dropdown-menu">
									  <li><a href="javascript:window.open('./crear_poligono.php','verPoligono','width=900, height=720');">Nuevo</a></li>
									</ul>
								  </div>
								</th>
                            </tr>
						...
						<?php
							...
							$q = "SELECT id, name, tipo FROM traccar.geofences ORDER BY name;";
						...
						?>
							<tr>
								...
								<td style="vertical-align: middle;" nowrap><?php echo $row["tipo"];?></td>
								<td style="vertical-align: middle;">
									...
									<ul class="dropdown-menu">
									  <li><a href="javascript:window.open('./ver_poligono.php?pid=<?php echo $row["id"];?>','verPoligono','width=900, height=720');">Mapa</a></li>
									</ul>
								  </div>
								</td>
							</tr>
